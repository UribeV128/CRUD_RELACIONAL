                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDM/editarDatos.php" method="post">
                            ...
                            $sql = "SELECT * FROM tbl_categoria WHERE idCategoria =" . $_REQUEST['Id'];
                            ...
                            <div class="mb-3">
                                <label for="nombreC" class="form-label">Nombre de Categoria</label>
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre de Categoria" value="<?php echo $row['nombreCategoria'] ?>">
                            </div>
