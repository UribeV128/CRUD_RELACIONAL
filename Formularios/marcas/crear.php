    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">REGISTRAR CATEGORIA</h5>
                        <form action="<?php echo base_url; ?>CRUDM/insertarDatos.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre de categoria" required>
                            </div>
